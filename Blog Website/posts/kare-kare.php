                      ...
                      <div class="postBody" id="postBody">
                        <div class="separator" style="clear: both;">
                          <div class="separator" style="clear: both; text-align: center;">
                            <img data-original-height="1200" data-original-width="900" height="640" src="../images/kare-kare.jpg" width="480" />
                          </div>
                        </div>
                        <p style="font-size: 12px; margin-top: 0px; text-align: center;">
                          Well-served Kare-Kare
                        </p>
                          ...
                          <div class="tabsContent">
                            <div class="tabsContent-1">
                              <p style="font-size: 15px; margin-top: -13px; text-align: justify;">
                                This is yet another stew dish in Filipino cuisine, but what’s unique about kare-kare as a Filipino food is how it has a thick savory peanut sauce that gives it a rich and distinct flavor. Traditionally made with oxtail, tripe, or beef, kare-kare is a beloved comfort food that showcases the creativity and resourcefulness of Filipino cooking.
                                The dish is often accompanied by a colorful medley of vegetables, such as eggplant, banana hearts, and string beans, which not only add texture but also enhance the overall presentation. The peanut sauce, made from ground peanuts or peanut butter, is the star of the dish, providing a creamy and nutty base that perfectly complements the tender meat and fresh vegetables.
                                Kare-kare is typically served with a side of bagoong (fermented shrimp paste), which adds a salty contrast to the sweetness of the peanut sauce. This combination creates a delightful balance of flavors that makes kare-kare a favorite at family gatherings and special occasions. With its hearty ingredients and comforting taste, kare-kare is more than just a meal; it’s a celebration of Filipino culture and culinary tradition.
                              </p>
                            </div>
                            <div class="tabsContent-2">
                              <div class="spe">
                                <p>
                                  ...
                                  <ul>
                                    <li>1 lb oxtail (or beef/tripe)</li>
                                    <li>6 cups water</li>
                                    <li>1 medium onion, chopped</li>
                                    <li>1/2 cup peanut butter</li>
                                    <li>1/4 cup ground peanuts (optional)</li>
                                    <li>1 eggplant, sliced</li>
                                    <li>1 cup banana hearts, sliced</li>
                            ...
                            <div class="tabsContent-3">
                              <div class="spe">
                                <p>
                                  ...
                                  <ol>
                                    <li>In a large pot, boil the oxtail (or chosen meat) in water until tender, about 1.5 to 2 hours.</li>
                                    <li>Remove the meat and set aside, reserving the broth.</li>
                                    <li>In the same pot, sauté the onion until translucent.</li>
                                    <li>Add the reserved broth back to the pot and stir in the peanut butter and ground peanuts, mixing well.</li>
                                    <li>Add the cooked meat and bring to a simmer.</li>
                                    <li>Add the eggplant, banana hearts, and string beans, cooking until the vegetables are tender.</li>
                                    <li>Season with salt and pepper to taste. Serve hot with bagoong on the side.</li>
                                  </ol>
                                </p>    
                              </div>
                            </div>
                            <div class="tabsContent-4">
                              <p style="font-size: 15px; margin-top: -13px; text-align: justify;">
                                4 servings if served as a main dish with rice and bagoong.
                              </p>
                            </div>
                          </div>
                        </div>
