                      ...
                      <div class="postBody" id="postBody">
                        <div class="separator" style="clear: both;">
                          <div class="separator" style="clear: both; text-align: center;">
                            <img data-original-height="1200" data-original-width="900" height="640" src="../images/Kinilaw.jpg" width="480" />
                          </div>
                        </div>
                          ...
                          <div class="tabsContent">
                            <div class="tabsContent-1">
                              <p style="font-size: 15px; margin-top: -13px; text-align: justify;">
                                Kinilaw is a Filipino appetizer made with raw, cubed fish in a dressing based on vinegar mixed with garlic, ginger, and sometimes coconut milk, creating a refreshing and zesty dish that tantalizes the taste buds. This traditional dish is often enjoyed as a starter or side, showcasing the vibrant flavors of the Philippines' coastal cuisine.
                                While kinilaw is typically made with fresh fish like tuna or mackerel, it can also include a variety of seafood, such as shrimp or squid. The key to a great kinilaw lies in the freshness of the ingredients, as the fish is "cooked" in the acidity of the vinegar, resulting in a delicate texture and bright flavor.
                                Accompanied by chopped onions, tomatoes, and chili peppers, kinilaw is a perfect balance of tangy, spicy, and savory notes. It is often served chilled, making it an ideal dish for warm weather or festive gatherings. With its vibrant colors and bold flavors, kinilaw not only delights the palate but also embodies the rich culinary heritage of the Philippines, celebrating the bounty of the sea in every bite.
                              </p>
                            </div>
                            <div class="tabsContent-2">
                              <div class="spe">
                                <p>
                                  ...
                                  <ul>
                                    <li>500g, cubed Fresh tuna (or tanigue)</li>
                                    <li>¾ cup Vinegar (coconut or cane)</li>
                                    <li>¼ cup Calamansi juice</li>
                                    <li>1 medium, sliced thin Red onion</li>
                                    <li>2 tbsp, minced Ginger</li>
                                    <li>2 pcs, sliced Green chili (siling haba)</li>
                                    <li>1 tsp Salt</li>
                                    <li>½ tsp Ground black pepper</li>
                                    <li>¼ cup Coconut milk (Optional)</li>
                                    <li>½ cup, julienned cucumber or green mango (Optional)</li>
                                  </ul>
                                </p>    
                              </div>
                            </div>
                            <div class="tabsContent-3">
                              <div class="spe">
                                <p>
                                  ...
                                  <ol>
                                    <li>Wash the fish thoroughly in cold water then cut into uniform cubes (about ½ inch thick).</li>
                                    <li>Place in a bowl and pour vinegar over it. Let sit for 2 minutes, then drain. This step removes the fishy odor and firms up the flesh.</li>
                                    <li>Add calamansi juice to the drained fish. Mix gently to coat all pieces. Let it sit for 10–15 minutes. The acid will "cook" the fish, turning it opaque.</li>
                                    <li>Mix in red onions, ginger, green chili, salt, and pepper. Toss gently to combine.</li>
                                    <li>For a richer version, stir in coconut milk.</li>
                                    <li>Add cucumber or green mango for crunch and acidity.</li>
                                </p>    
                              </div>
                            </div>
                            <div class="tabsContent-4">
                              <p style="font-size: 15px; margin-top: -13px; text-align: justify;">
                                4 servings as a starter or pulutan (bar chow).
                                2–3 servings if served as a main dish with rice or grilled sides.
                              </p>
                            </div>
                          </div>
                        </div>
                    ...
                    <div id="relatedPosts">
                      ...
                      <ul class="related style-2">
                        ...
                        <li>
                          <div class="item">
                            <div class="itemThumbnail postThumbnail">
                              <a aria-label="Sisig" href="../posts/sisig.php">
                                <div class="lazyloaded">
