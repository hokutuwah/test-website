                      ...
                      <div class="postBody" id="postBody">
                        <div class="separator" style="clear: both;">
                          <div class="separator" style="clear: both; text-align: center;">
                            <img data-original-height="1200" data-original-width="900" height="640" src="../images/sinigang.jpg" width="480" />
                          </div>
                        </div>
                          ...
                          <div class="tabsContent">
                            <div class="tabsContent-1">
                              <p style="font-size: 15px; margin-top: -13px; text-align: justify;">
                                It is a Filipino stew composed of meat or seafood and uses tamarind (sampalok) as the souring agent, giving it a distinctive tang that sets it apart from other dishes. Sinigang is not just a meal; it’s a culinary experience that reflects the heart and soul of Filipino culture.
                                Traditionally, this comforting stew features a variety of proteins, including pork, beef, shrimp, or fish, each simmered to tender perfection in a flavorful broth. The addition of fresh vegetables like radish, eggplant, and water spinach not only enhances the dish's taste but also adds a burst of color and nutrition.
                                Sinigang is often served hot, accompanied by a bowl of steamed rice, making it a perfect dish for family gatherings or cozy dinners. Its warm, savory aroma fills the kitchen, inviting everyone to the table. Whether enjoyed on a rainy day or as a comforting meal after a long day, sinigang is a beloved staple that brings people together, celebrating the rich flavors and traditions of the Philippines.
                              </p>
                            </div>
                            <div class="tabsContent-2">
                              <div class="spe">
                                <p>
                                  ...
                                  <ul>
                                    <li>1 lb pork (or shrimp/fish)</li>
                                    <li>6 cups water</li>
                                    <li>1 medium onion, quartered</li>
                                    <li>2 medium tomatoes, quartered</li>
                                    <li>1 cup tamarind paste (or 1 cup fresh tamarind)</li>
                            ...
                            <div class="tabsContent-3">
                              <div class="spe">
                                <p>
                                  ...
                                  <ol>
                                    <li>In a large pot, bring the water to a boil and add the pork (or chosen protein). Cook until tender.</li>
                                    <li>Add the onion and tomatoes, and simmer for about 10 minutes.</li>
                                    <li>Stir in the tamarind paste, adjusting the sourness to your preference.</li>
                                    <li>Add the radish and eggplant, cooking until they are tender.</li>
                                    <li>Finally, add the water spinach and season with salt and pepper. Cook for an additional 2-3 minutes.</li>
                            ...
                            <div class="tabsContent-4">
                              <p style="font-size: 15px; margin-top: -13px; text-align: justify;">
                                4 servings as a main dish with rice.
                              </p>
                            </div>
                          </div>
                        </div>
