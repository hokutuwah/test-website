                      ...
                      <div class="postBody" id="postBody">
                        <div class="separator" style="clear: both;">
                          <div class="separator" style="clear: both; text-align: center;">
                            <img data-original-height="1200" data-original-width="900" height="640" src="../images/lechon.jpg" width="480" />
                          </div>
                        </div>
                          ...
                          <div class="tabsContent">
                            <div class="tabsContent-1">
                              <p style="font-size: 15px; margin-top: -13px; text-align: justify;">
                                Lechon, or roasted suckling pig, is a beloved Filipino dish renowned for its crispy skin and tender, flavorful meat. This culinary masterpiece is often the centerpiece of celebrations, symbolizing abundance and festivity. The preparation of lechon involves marinating the pig with a blend of spices, then slow-roasting it over an open flame or in an oven until the skin achieves a golden-brown crispiness. The result is a dish that is not only visually stunning but also a delight to the palate, with a perfect balance of savory and slightly sweet flavors.
                                Lechon is commonly served during fiestas or special occasions like birthdays, weddings, and holidays, where it brings families and friends together in a joyous feast. The tradition of serving lechon is deeply rooted in Filipino culture, often accompanied by a rich liver sauce or vinegar dipping sauce that enhances its flavors. Beyond its delicious taste, lechon represents a sense of community and celebration, making it an essential part of Filipino gatherings. Whether enjoyed at a large family reunion or a small get-together, lechon continues to be a cherished dish that embodies the spirit of Filipino hospitality and culinary heritage.
                              </p>
                            </div>
                            <div class="tabsContent-2">
                              <div class="spe">
                                <p>
                                  ...
                                  - 1 whole pig (about 20-30 lbs)<br>
                                  - 1 cup of salt<br>
                                  - 1 cup of soy sauce<br>
                                  - 1 cup of vinegar<br>
                                  - 1 head of garlic, minced<br>
                                  - 2-3 stalks of lemongrass, chopped<br>
                                  - 1-2 cups of water<br>
                                  - Optional: spices like black pepper, bay leaves, and onions for additional flavor.
                                </p>    
                              </div>
                            </div>
                            <div class="tabsContent-3">
                              <div class="spe">
                                <p>
                                  ...
                                  1. Clean the pig thoroughly, removing any hair and innards. Rinse with water and pat dry.<br>
                                  2. In a bowl, mix salt, soy sauce, vinegar, minced garlic, and chopped lemongrass to create a marinade.<br>
                                  3. Rub the marinade all over the pig, including the inside cavity. Let it marinate for at least 12 hours, preferably overnight.<br>
                                  4. Preheat your oven or prepare a charcoal pit for roasting. If using an oven, set it to 250°F (120°C).<br>
                                  5. Place the pig on a roasting rack, ensuring it is secured and balanced. If using a charcoal pit, ensure the coals are evenly distributed.<br>
                                  6. Roast the pig for about 6-8 hours, basting it with water or marinade every hour to keep it moist.<br>
                                  7. For crispy skin, increase the heat to 400°F (200°C) during the last 30 minutes of cooking.<br>
                                  8. Once cooked, let the lechon rest for about 30 minutes before carving.<br>
                                  9. Serve with a dipping sauce made from vinegar, soy sauce, and chopped chili.
                                </p>    
                              </div>
                            </div>
                    ...
                    <div id="relatedPosts">
                      ...
                      <ul class="related style-2">
                        <li>
                          <div class="item">
                            <div class="itemThumbnail postThumbnail">
                              <a aria-label="Bulalo" href="../posts/balut.php">
                        ...
                        <li>
                          <div class="item">
                            <div class="itemThumbnail postThumbnail">
                              <a aria-label="Bulalo" href="../posts/bulalo.php">
                                <div class="lazyloaded">
                                  <img src="../images/bulalo.jpg" />
                                </div>
                              </a>
                            </div>
                            <div class="itemTitle">
                        ...
                        <li>
                          <div class="item">
                            <div class="itemThumbnail postThumbnail">
                              <a aria-label="pancit" href="pancit.php">
                                <div class="lazyloaded">
